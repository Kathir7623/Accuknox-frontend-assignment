  ...
  return (
    <Modal open={showAddWidget} onClose={cancel} closeIcon>
      ...
      <div className="absolute right-2 bottom-2">
        <button
          className="border border-[#236c1e] rounded-md p-2.5"
          onClick={cancel}
        >
          cancel
        </button>
        <button
          className="bg-[#266817] text-[#fff] rounded-md p-2.5 ml-2"
          onClick={() =>
